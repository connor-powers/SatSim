...
std::array<double, T> RK4_step(
    ...
    const double input_spacecraft_mass,
    std::vector<std::array<double, 3>> input_vec_of_force_vectors_in_ECI_at_t =
        {},
...
void sim_and_plot_orbital_elem_gnuplot(
    ...
    std::string input_orbital_element_name, bool perturbation = true);
void sim_and_plot_attitude_evolution_gnuplot(
    std::vector<Satellite> input_satellite_vector, double input_timestep,
    double input_total_sim_time, double input_epsilon,
    std::string input_plotted_val_name, bool perturbation = true);

Matrix3d rollyawpitch_bodyframe_to_LVLH(
    std::array<double, 3> input_bodyframe_vec, double input_roll,
    double input_pitch, double input_yaw);
std::array<double, 4> rollyawpitch_angles_to_quaternion(double input_roll,
                                                        double input_pitch,
                                                        double input_yaw);
std::array<double, 4> rollpitchyaw_angles_to_quaternion(double input_roll,
                                                        double input_pitch,
                                                        double input_yaw);
...
std::pair<std::array<double, T>, std::pair<double, double>> RK45_step(
    std::array<double, T> y_n, double input_step_size,
    std::function<std::array<double, T>(
        std::array<double, T>, Matrix3d, std::vector<BodyframeTorqueProfile>,
        Vector3d, double, Matrix3d, Vector3d, double,
        std::vector<ThrustProfileLVLH>, double, double, double, double, bool)>
    ...
    double input_true_anomaly, bool perturbation, double input_t_n,

...
TEST(UtilsTests, OrbitalElementPlottingTests) {
    ...
    double t_thrust_start = 100;
    double t_thrust_end = 200;
    ...
    double t_thrust_2_start = 150;
    double t_thrust_2_end = 250;
    ...
    Satellite test_sat_torque("../tests/elliptical_orbit_test_1.json");
    ...
    Satellite test_sat_none("../tests/elliptical_orbit_test_1.json");

    std::vector<Satellite> satellite_vector = {test_sat_none,test_sat_thrust,test_sat_torque,test_sat_both};

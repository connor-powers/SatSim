...
int main() {
  ...
  //     std::pair<double,int>
  //     output_pair=test_sat_1.evolve_RK45(epsilon,test_timestep); double
  //     next_timestep=output_pair.first; std::cout << "next timestep: " <<
  ...
  //     "\n"; std::cout << "omega_y: " <<
  //     test_sat_1.get_attitude_val("omega_y")<< "\n"; std::cout << "omega_z: "
  //     << test_sat_1.get_attitude_val("omega_z")<< "\n"; std::cout << "q_0: "
  //     << test_sat_1.get_attitude_val("q_0")<< "\n"; std::cout << "q_1: " <<
  //     test_sat_1.get_attitude_val("q_1")<< "\n"; std::cout << "q_2: " <<
  //     test_sat_1.get_attitude_val("q_2")<< "\n"; std::cout << "q_3: " <<
  //     test_sat_1.get_attitude_val("q_3")<< "\n";
  // }
  ...
  // sim_and_plot_orbital_elem_gnuplot(satellite_vector_3,timestep,total_sim_time,epsilon,"True
  // Anomaly");
  // sim_and_plot_orbital_elem_gnuplot(satellite_vector_3,timestep,total_sim_time,epsilon,"Eccentricity");

  // sim_and_plot_orbital_elem_gnuplot(satellite_vector_3,timestep,total_sim_time,epsilon,"Orbital
  // Rate");
  // sim_and_plot_orbital_elem_gnuplot(satellite_vector_3,timestep,total_sim_time,epsilon,"Orbital
